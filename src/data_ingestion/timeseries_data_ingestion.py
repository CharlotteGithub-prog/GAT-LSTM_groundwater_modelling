...
def load_aet_data_old(catchment: float, shape_filepath: float, required_crs: int, cdsapi_path: str,
...
def load_era5_land_data(catchment: float, shape_filepath: float, required_crs: int, cdsapi_path: str,
                  start_date: str, end_date: str, run_era5_land_api: bool, raw_output_dir: str,
                  processed_output_dir: str, aet_csv_path: str, aet_fig_path: str, era5_feat: str = 'e',
